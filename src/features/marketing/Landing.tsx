    ...
    <div className={outerWrapper}>
      <main className={heroSection}>
        ...
        <div className={featuresTripleGrid} aria-label="Core Architectural Pillars">
          ...
          <div className={featureCardFrame}>
            <h3 className={featureCardTitle}>
              <span className="material-symbols-outlined text-sm">analytics</span>A Fix, Not Just a
              Number
            </h3>
            <p className={featureCardBody}>
              Every finding is ranked by monthly cost and paired with one specific, actionable step
              — not a generic line item, a real thing to go change.
            </p>
          </div>
        </div>
          ...
          <div className={demoCard}>
            ...
            <div className="space-y-3">
              {sampleFindings.map((finding) => (
                <div
                  key={finding.label}
                  className="pb-3 border-b border-surface-variant/10 last:border-0"
                >
                  ...
                  <p className="font-mono text-[10px] uppercase tracking-wider text-on-surface-variant/50 mt-1">
